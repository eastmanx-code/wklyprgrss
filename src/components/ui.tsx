  ...
  return (
    <section className="panel mb-5">
      <div className="flex items-start justify-between gap-4">
        <div>
          <p className="label">Company completion</p>
          <p className="mt-1 font-mono text-4xl tabular-nums">{percent}%</p>
        </div>
        <div className="text-right">
          <p className="label">Venues finished</p>
          <p className="mt-1 font-mono text-2xl tabular-nums">
            {venuesPassing}
            <span className="text-muted">/{venuesTotal}</span>
          </p>
        </div>
      </div>

      <div className="mt-4 h-[10px] overflow-hidden rounded-full bg-panel">
        <div
